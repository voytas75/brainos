# BrainOS usage test — 20260707-210352
...
```
Initialized /tmp/brainos-usage-20260707-210352.db
```
...
```
231b875e-1ac9-473d-bc6b-79760de152a0
```

### ep2 — OK

```
36700e31-ac7f-4536-91a1-c2eed4b7c8db
```

### ep3 — OK

```
ebdfc1ac-7f59-43f0-918d-261023a56d78
```
...
[
  {
    "id": "ebdfc1ac-7f59-43f0-918d-261023a56d78",
    "session_id": "usage-test",
    "timestamp": "2026-07-07 19:03:53",
    ...
    "vector_state": {
      "object_type": "episode",
      "object_id": "ebdfc1ac-7f59-43f0-918d-261023a56d78",
      ...
      "last_error": null,
      "last_error_at": null,
      "updated_at": "2026-07-07 19:03:53"
    }
  },
  {
    "id": "36700e31-ac7f-4536-91a1-c2eed4b7c8db",
    "session_id": "usage-test",
    "timestamp": "2026-07-07 19:03:53",
    ...
    "vector_state": {
      "object_type": "episode",
      "object_id": "36700e31-ac7f-4536-91a1-c2eed4b7c8db",
  ...
  {
    "id": "231b875e-1ac9-473d-bc6b-79760de152a0",
    "session_id": "usage-test",
    "timestamp": "2026-07-07 19:03:53",
    ...
    "vector_state": {
      "object_type": "episode",
      "object_id": "231b875e-1ac9-473d-bc6b-79760de152a0",
  ...
  "episodes": [
    {
      ...
      "vector_state": {
        ...
        "vector_status": "fresh",
        "last_embedded_at": "2026-07-07T19:03:56+00:00",
        "last_error": null,
        "last_error_at": null,
        "updated_at": "2026-07-07 19:03:56"
      }
    }
  ],
  "vector_episodes": [
...
```
{
  ...
  "comparison_hint": {
    "top_id": "36700e31-ac7f-4536-91a1-c2eed4b7c8db",
    "runner_up_id": "ebdfc1ac-7f59-43f0-918d-261023a56d78",
    "score_gap": 1308.635,
    "top_kind": "fact",
    "runner_up_kind": "fact"
  },
...
```
{
  ...
  "comparison_hint": {
    "top_id": "ebdfc1ac-7f59-43f0-918d-261023a56d78",
    "runner_up_id": "36700e31-ac7f-4536-91a1-c2eed4b7c8db",
    "score_gap": 1388.94,
    "top_kind": "fact",
    "runner_up_kind": "fact"
  },
...
```
{
  ...
  "comparison_hint": {
    "top_id": "ebdfc1ac-7f59-43f0-918d-261023a56d78",
    "runner_up_id": "231b875e-1ac9-473d-bc6b-79760de152a0",
    "score_gap": 1505.391,
    "top_kind": "fact",
    "runner_up_kind": "fact"
  },
