...
def suppress_litellm_noise() -> Generator[None, None, None]:
    ...
    previous_states = [
        ...
        (
            litellm_router_logger,
            litellm_router_logger.disabled,
            litellm_router_logger.level,
        ),
        (
            litellm_proxy_logger,
            litellm_proxy_logger.disabled,
            litellm_proxy_logger.level,
        ),
    ]
